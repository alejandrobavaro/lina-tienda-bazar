      ...
      <div className="auth-container">
        {loading ? (
          ...
          <div className="auth-content">
            <img className='auth-image top-image' src="/img/05-img-costados-larga/logopequeño2.png" alt="" />
            ...
            <img className='auth-image bottom-image' src="/img/05-img-costados-larga/logopequeño1.png" alt="" />
          </div>
        )}
      </div>
    </div>
